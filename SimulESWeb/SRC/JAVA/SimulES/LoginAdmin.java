...
import SimulES.Control.AdminController;
import SimulES.Model.Admin;
 ...
 * @version Created on Aug 24, 2011, 3:51:26 PM
...
public class LoginAdmin extends AbstractPageBean {
    ...
    public boolean loginValidation() {
        ...
        if (!admincontroller.adminExist(nickname)) {
            FacesMessage fm = new FacesMessage("User does not exist");
            fm.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, fm);
        } else {
            String password = txtPassword.getText().toString();
            if (admincontroller.passwordIsCorrect(nickname, password)) {
                trueUser = true;
            } else {
                FacesMessage fm = new FacesMessage("Password is incorrect");
                fm.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext.getCurrentInstance().addMessage(null, fm);
            }
        }
