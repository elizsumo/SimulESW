 ...
 *
 * @version MastheadMain.java
 * @version Created on Oct 16, 2011, 4:30:54 PM
 * @author elizsumoComputer
 */

public class MastheadMain extends AbstractFragmentBean {
    ...
    private Button btnPlayer2 = new Button();

    public Button getBtnPlayer2() {
        return btnPlayer2;
    }

    public void setBtnPlayer2(Button b) {
        this.btnPlayer2 = b;
    }
    ...
    public String btnPlayer1_action() {
       btnPlayer2.setDisabled(true);
